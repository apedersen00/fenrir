...
package kernel_weights_pkg is
    ...
    constant KERNEL_WEIGHTS : kernel_weights_t := (
         0 => (  10,   10,   11,   12), -- Pos(0,0)
         1 => (  16,   17,   19,   20), -- Pos(0,1)
         2 => (  10,   10,   11,   12), -- Pos(0,2)
         3 => (  16,   17,   19,   20), -- Pos(1,0)
         4 => (  26,   29,   31,   34), -- Pos(1,1)
         5 => (  16,   17,   19,   20), -- Pos(1,2)
         6 => (  10,   10,   11,   12), -- Pos(2,0)
         7 => (  16,   17,   19,   20), -- Pos(2,1)
         8 => (  10,   10,   11,   12), -- Pos(2,2)
    );
